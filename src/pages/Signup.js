        ...
        <div className="flex justify-center  center_parent w-4/5 h-4/5 ">
            <div className="w-full h-full mt-4 shadow-lg z-2 border-lg  flex mt-24">
                <div className="bg-white w-1/2 h-full flex  flex-col items-center justify-between px-2">
                    <div className="flex flex-col flex-shrink justify-center items-center h-1/5">
                      <div className="mt-4 ">
                    ...
                    <div className="w-4/5 flex  justify-center h-3/5 flex-shrink items-center">
                        <form className=" flex flex-grow flex-col border-2 items-center border-blue-200 rounded-sm h-full w-4/5 text-center justify-between" onSubmit={async(e)=>{await handleSubmit(e)}} >
                            ...
                            <div className="w-3/4">
                                ...
                                <span className="text-red-500 lg:text-md md:text-sm sm:text-xs">{passwordError}</span>
                            </div>
                    ...
                    <div className="h-1/5 flex flex-col justify-end items-end">
